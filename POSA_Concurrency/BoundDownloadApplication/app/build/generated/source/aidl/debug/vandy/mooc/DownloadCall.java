 ...
 * Original file: C:\\Users\\kuladasd\\AndroidstudioProjects\\BoundDownloadApplication\\app\\src\\main\\aidl\\vandy\\mooc\\DownloadCall.aidl
 */
package vandy.mooc;
/**
 * @class DownloadCall
...
public static abstract class Stub extends android.os.Binder implements vandy.mooc.DownloadCall
{
private static final java.lang.String DESCRIPTOR = "vandy.mooc.DownloadCall";
...
/**
 * Cast an IBinder object into an vandy.mooc.DownloadCall interface,
 * generating a proxy if needed.
 */
public static vandy.mooc.DownloadCall asInterface(android.os.IBinder obj)
{
if ((obj==null)) {
return null;
}
android.os.IInterface iin = obj.queryLocalInterface(DESCRIPTOR);
if (((iin!=null)&&(iin instanceof vandy.mooc.DownloadCall))) {
return ((vandy.mooc.DownloadCall)iin);
}
return new vandy.mooc.DownloadCall.Stub.Proxy(obj);
}
...
private static class Proxy implements vandy.mooc.DownloadCall
{
