...
class RequestHandler extends Handler {
    ...
    public void handleMessage(Message message) {
        ...
        // TODO -- you fill in here.
      //  final Uri url= Uri.parse(requestMessage.getData().toString());
        ...
        final Runnable downloadImageAndReply = 
            new Runnable() {
                ...
                public void run() {
                    ...
                    Uri imagePath=Utils.downloadImage(mService.get(),url,directoryPath);

                    // Send the path to the image file, url, and
                    // requestCode back to the Activity via the
                    // replyMessenger.
                    // TODO -- you fill in here.
                    sendPath(messenger, imagePath, url, requestCode);
                }
            };
