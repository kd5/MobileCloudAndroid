...
public class DownloaderTaskFragment extends Fragment {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		ArrayList<Integer> integerlist = bundle
				.getIntegerArrayList(TAG_FRIEND_RES_IDS);

		// TODO: Start the DownloaderTask

		dtask.execute(integerlist);
	...
	public class DownloaderTask extends
		...
		@Override
		protected String[] doInBackground(ArrayList<Integer>... arg0) {
			// TODO Auto-generated method stub

			Integer[] inputValues = convertToIntArray(arg0[0]);

			String[] dtweets = downloadTweets(inputValues);

			return dtweets;
		}

		public Integer[] convertToIntArray(List<Integer> integers) {
			Integer[] resultInt = new Integer[integers.size()];
			for (int i = 0; i < resultInt.length; i++) {
				resultInt[i] = integers.get(i).intValue();
			}
			return resultInt;
		}
